...
<p align="center">
  <img src="assets/banner.svg" alt="Awesome Safety Alignment Banner" width="100%">
</p>
...
```mermaid
flowchart TD
    A["🛡️ 2020: Heuristic Token Filtering<br/>Hardcoded Regex & Word Blacklists (Brittle)"]
...
*   **Vulnerability ⚠️:** Completely blind to context. Metaphors, fictional safe contexts, or obfuscated spelling easily bypassed the filters.
...
*   **Vulnerability ⚠️:** Reward hacking (the model learns to sound hyper-polite or over-refuses harmless queries to maximize reward scores without solving the root safety risk).
...
| **DPO** | Closed-form preference loss | 🟡 Moderate-High | Prone to over-refusal errors |
| **Constitutional AI**| Machine-critiqued alignment | 🟢 Extreme (Autonomous self-loops) | Blind spots in the rule constitution |
| **Circuit Breakers** | Neuron-level concept deletion | 🟡 Moderate (Requires deep maps) | Potential collateral damage to benign knowledge |
